// Product-voice messages returned by the API. Kept calm and plain; scanned by
// the copy sweep. Do not add em-dashes, banned vocabulary, or negative
// empty-state phrasing here.
export const copy = {
  unauthorized: "Please sign in to continue.",
  forbidden: "This space is private to its family.",
